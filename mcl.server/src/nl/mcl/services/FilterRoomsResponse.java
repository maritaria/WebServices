...
/**
 * FilterRoomsResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class FilterRoomsResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.mcl.nl/",
			"FilterRoomsResponse", "ns2");
	 ...
	 */
	protected void validateRoom(nl.mcl.services.Room[] param) {
	 ...
	 * 
	 * @param param
	 *            nl.mcl.services.Room
	 */
	public void addRoom(nl.mcl.services.Room param) {
		if (localRoom == null) {
			localRoom = new nl.mcl.services.Room[] {};
		}
		...
		list.add(param);
		this.localRoom = (nl.mcl.services.Room[]) list.toArray(new nl.mcl.services.Room[list.size()]);
	...
	public static class Factory {
		 ...
		 */
		public static FilterRoomsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FilterRoomsResponse".equals(type)) {
							...
							return (FilterRoomsResponse) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "room").equals(reader.getName())) {
					...
					list1.add(nl.mcl.services.Room.Factory.parse(reader));
					...
					object.setRoom((nl.mcl.services.Room[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(nl.mcl.services.Room.class, list1));
