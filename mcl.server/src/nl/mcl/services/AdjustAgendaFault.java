...
/**
 * AdjustAgendaFault bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class AdjustAgendaFault implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.mcl.nl/",
			"AdjustAgendaFault", "ns2");
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"AdjustAgendaFault".equals(type)) {
							...
							return (AdjustAgendaFault) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
