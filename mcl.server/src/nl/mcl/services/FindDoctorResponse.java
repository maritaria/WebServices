...
/**
 * FindDoctorResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class FindDoctorResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.mcl.nl/",
			"FindDoctorResponse", "ns2");

	/**
	 * field for Candidate This was an Array!
	 */

	protected nl.mcl.services.Doctor[] localCandidate;
	 ...
	 */
	public nl.mcl.services.Doctor[] getCandidate() {
	 ...
	 */
	protected void validateCandidate(nl.mcl.services.Doctor[] param) {
	 ...
	 *            Candidate
	 */
	public void setCandidate(nl.mcl.services.Doctor[] param) {
	 ...
	 */
	public void addCandidate(nl.mcl.services.Doctor param) {
		if (localCandidate == null) {
			localCandidate = new nl.mcl.services.Doctor[] {};
		}
		...
		list.add(param);
		this.localCandidate = (nl.mcl.services.Doctor[]) list.toArray(new nl.mcl.services.Doctor[list.size()]);
		...
		public static FindDoctorResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FindDoctorResponse".equals(type)) {
							...
							return (FindDoctorResponse) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
					...
					list1.add(nl.mcl.services.Doctor.Factory.parse(reader));
					...
					object.setCandidate((nl.mcl.services.Doctor[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(nl.mcl.services.Doctor.class, list1));
