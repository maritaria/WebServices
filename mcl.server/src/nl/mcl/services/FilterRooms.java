...
/**
 * FilterRooms bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class FilterRooms implements org.apache.axis2.databinding.ADBBean {
	...
	protected nl.mcl.services.RoomFilter localFilter;

	/**
	 * Auto generated getter method
	 * 
	 * @return nl.mcl.services.RoomFilter
	 */
	public nl.mcl.services.RoomFilter getFilter() {
		return localFilter;
	}
	 ...
	 *            Filter
	 */
	public void setFilter(nl.mcl.services.RoomFilter param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FilterRooms", xmlWriter);
			}
		...
		public static FilterRooms parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FilterRooms".equals(type)) {
							...
							return (FilterRooms) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "filter").equals(reader.getName())) {
					...
					object.setFilter(nl.mcl.services.RoomFilter.Factory.parse(reader));
