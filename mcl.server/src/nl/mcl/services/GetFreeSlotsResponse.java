...
/**
 * GetFreeSlotsResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetFreeSlotsResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.mcl.nl/",
			"GetFreeSlotsResponse", "ns2");

	/**
	 * field for GetFreeSlotsResponseSequence This was an Array!
	 */

	protected nl.mcl.services.GetFreeSlotsResponseSequence[] localGetFreeSlotsResponseSequence;
	 ...
	 * 
	 * @return nl.mcl.services.GetFreeSlotsResponseSequence[]
	 */
	public nl.mcl.services.GetFreeSlotsResponseSequence[] getGetFreeSlotsResponseSequence() {
	 ...
	 */
	protected void validateGetFreeSlotsResponseSequence(nl.mcl.services.GetFreeSlotsResponseSequence[] param) {
	 ...
	 */
	public void setGetFreeSlotsResponseSequence(nl.mcl.services.GetFreeSlotsResponseSequence[] param) {
	 ...
	 * 
	 * @param param
	 *            nl.mcl.services.GetFreeSlotsResponseSequence
	 */
	public void addGetFreeSlotsResponseSequence(nl.mcl.services.GetFreeSlotsResponseSequence param) {
		if (localGetFreeSlotsResponseSequence == null) {
			localGetFreeSlotsResponseSequence = new nl.mcl.services.GetFreeSlotsResponseSequence[] {};
		}
		...
		list.add(param);
		this.localGetFreeSlotsResponseSequence = (nl.mcl.services.GetFreeSlotsResponseSequence[]) list
				.toArray(new nl.mcl.services.GetFreeSlotsResponseSequence[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (localGetFreeSlotsResponseSequenceTracker) {
			...
			if (localGetFreeSlotsResponseSequence != null) {
				...
				throw new org.apache.axis2.databinding.ADBException("GetFreeSlotsResponseSequence cannot be null!!");
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetFreeSlotsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetFreeSlotsResponse".equals(type)) {
							...
							return (GetFreeSlotsResponse) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				try {
					...
					if (reader.isStartElement()) {
						...
						list1.add(nl.mcl.services.GetFreeSlotsResponseSequence.Factory.parse(reader));
						...
						object.setGetFreeSlotsResponseSequence(
								(nl.mcl.services.GetFreeSlotsResponseSequence[]) org.apache.axis2.databinding.utils.ConverterUtil
										.convertToArray(nl.mcl.services.GetFreeSlotsResponseSequence.class, list1));
