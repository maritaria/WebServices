...
/**
 * ReserveRoom bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class ReserveRoom implements org.apache.axis2.databinding.ADBBean {
	...
	protected nl.mcl.services.TimeSlot localSlot;
	 ...
	 */
	public nl.mcl.services.TimeSlot getSlot() {
		return localSlot;
	}
	 ...
	 *            Slot
	 */
	public void setSlot(nl.mcl.services.TimeSlot param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ReserveRoom", xmlWriter);
			}
		...
		public static ReserveRoom parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ReserveRoom".equals(type)) {
							...
							return (ReserveRoom) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "slot").equals(reader.getName())) {
					...
					object.setSlot(nl.mcl.services.TimeSlot.Factory.parse(reader));
