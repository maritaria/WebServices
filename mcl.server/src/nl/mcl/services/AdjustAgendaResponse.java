...
/**
 * AdjustAgendaResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class AdjustAgendaResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.mcl.nl/",
			"AdjustAgendaResponse", "ns2");
	...
	public static class Factory {
		 ...
		 */
		public static AdjustAgendaResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"AdjustAgendaResponse".equals(type)) {
							...
							return (AdjustAgendaResponse) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "EntryID").equals(reader.getName())) {
