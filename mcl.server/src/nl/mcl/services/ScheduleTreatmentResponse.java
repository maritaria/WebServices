...
/**
 * ScheduleTreatmentResponse.java
 *
...
/**
 * ScheduleTreatmentResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class ScheduleTreatmentResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.mcl.nl/",
			"ScheduleTreatmentResponse", "ns2");

	/**
	 * field for Result
	 */

	protected nl.mcl.services.ScheduledTreatment localResult;

	/**
	 * Auto generated getter method
	 * 
	 * @return nl.mcl.services.ScheduledTreatment
	 */
	public nl.mcl.services.ScheduledTreatment getResult() {
		return localResult;
	}
	 ...
	 *            Result
	 */
	public void setResult(nl.mcl.services.ScheduledTreatment param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ScheduleTreatmentResponse",
						xmlWriter);
			}
		...
		public static ScheduleTreatmentResponse parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ScheduleTreatmentResponse".equals(type)) {
							...
							return (ScheduleTreatmentResponse) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "result").equals(reader.getName())) {
					...
					object.setResult(nl.mcl.services.ScheduledTreatment.Factory.parse(reader));
