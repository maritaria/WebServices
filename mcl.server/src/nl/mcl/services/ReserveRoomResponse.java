...
/**
 * ReserveRoomResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class ReserveRoomResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://services.mcl.nl/",
			"ReserveRoomResponse", "ns2");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (false) {
			...
			xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSucces));
		}
	...
	public static class Factory {
		 ...
		 */
		public static ReserveRoomResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ReserveRoomResponse".equals(type)) {
							...
							return (ReserveRoomResponse) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "succes").equals(reader.getName())) {
