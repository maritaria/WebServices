...
/**
 * RoomFilter bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class RoomFilter implements org.apache.axis2.databinding.ADBBean {
	/*
	...
	protected nl.mcl.services.TimeSlot[] localAvailableSlots;
	 ...
	 */
	public nl.mcl.services.TimeSlot[] getAvailableSlots() {
	 ...
	 */
	protected void validateAvailableSlots(nl.mcl.services.TimeSlot[] param) {
	 ...
	 *            AvailableSlots
	 */
	public void setAvailableSlots(nl.mcl.services.TimeSlot[] param) {
	 ...
	 */
	public void addAvailableSlots(nl.mcl.services.TimeSlot param) {
		if (localAvailableSlots == null) {
			localAvailableSlots = new nl.mcl.services.TimeSlot[] {};
		}
		...
		list.add(param);
		this.localAvailableSlots = (nl.mcl.services.TimeSlot[]) list.toArray(new nl.mcl.services.TimeSlot[list.size()]);
		...
		public static RoomFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"RoomFilter".equals(type)) {
							...
							return (RoomFilter) nl.mcl.services.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
					...
					list1.add(nl.mcl.services.TimeSlot.Factory.parse(reader));
					...
					object.setAvailableSlots(
							(nl.mcl.services.TimeSlot[]) org.apache.axis2.databinding.utils.ConverterUtil
									.convertToArray(nl.mcl.services.TimeSlot.class, list1));
