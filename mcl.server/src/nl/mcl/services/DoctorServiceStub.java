...
public class DoctorServiceStub extends org.apache.axis2.client.Stub {
	...
	public nl.mcl.services.FindDoctorResponse findDoctor(

			nl.mcl.services.FindDoctor findDoctor14)
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), findDoctor14,
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(),
					nl.mcl.services.FindDoctorResponse.class, getEnvelopeNamespaces(_returnEnv));

			return (nl.mcl.services.FindDoctorResponse) object;
	 ...
	 * 
	 * @see nl.mcl.services.DoctorService#startfindDoctor
	 * @param findDoctor14
	 * 
	 */
	public void startfindDoctor(

			nl.mcl.services.FindDoctor findDoctor14,

			final nl.mcl.services.DoctorServiceCallbackHandler callback)
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(),
							nl.mcl.services.FindDoctorResponse.class, getEnvelopeNamespaces(resultEnv));
					callback.receiveResultfindDoctor((nl.mcl.services.FindDoctorResponse) object);

				} catch (org.apache.axis2.AxisFault e) {
					callback.receiveErrorfindDoctor(e);
				}
			}
				...
				if (error instanceof org.apache.axis2.AxisFault) {
					...
					if (faultElt != null) {
						if (faultExceptionNameMap.containsKey(
								new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "FindDoctor"))) {
							// make the fault by reflection
							try {
								...
								callback.receiveErrorfindDoctor(new java.rmi.RemoteException(ex.getMessage(), ex));
							} catch (java.lang.ClassCastException e) {
								// we cannot intantiate the class - throw the original Axis fault
								callback.receiveErrorfindDoctor(f);
							} catch (java.lang.ClassNotFoundException e) {
								// we cannot intantiate the class - throw the original Axis fault
								callback.receiveErrorfindDoctor(f);
							} catch (java.lang.NoSuchMethodException e) {
					...
					callback.receiveErrorfindDoctor(error);
				}
			}
			...
			public void onComplete() {
				try {
					...
					callback.receiveErrorfindDoctor(axisFault);
				}
			}
		});
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			nl.mcl.services.FindDoctor param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
			throws org.apache.axis2.AxisFault {

		try {

			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
			emptyEnvelope.getBody().addChild(param.getOMElement(nl.mcl.services.FindDoctor.MY_QNAME, factory));
