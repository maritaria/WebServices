...
/**
 * GetFreeSlotsResponseSequence.java
 *
...
/**
 * GetFreeSlotsResponseSequence bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class GetFreeSlotsResponseSequence implements org.apache.axis2.databinding.ADBBean {
	/*
	...
	protected nl.mcl.services.TimeSlot[] localSlots;
	 ...
	 */
	public nl.mcl.services.TimeSlot[] getSlots() {
		return localSlots;
	}
	 ...
	 */
	protected void validateSlots(nl.mcl.services.TimeSlot[] param) {
	 ...
	 *            Slots
	 */
	public void setSlots(nl.mcl.services.TimeSlot[] param) {
	 ...
	 * 
	 * @param param
	 *            nl.mcl.services.TimeSlot
	 */
	public void addSlots(nl.mcl.services.TimeSlot param) {
		if (localSlots == null) {
			localSlots = new nl.mcl.services.TimeSlot[] {};
		}
		...
		list.add(param);
		this.localSlots = (nl.mcl.services.TimeSlot[]) list.toArray(new nl.mcl.services.TimeSlot[list.size()]);
	...
	public static class Factory {
		...
		public static GetFreeSlotsResponseSequence parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "Slots").equals(reader.getName())) {

					// Process the array and step past its final element's end.
					list2.add(nl.mcl.services.TimeSlot.Factory.parse(reader));
					...
					object.setSlots((nl.mcl.services.TimeSlot[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(nl.mcl.services.TimeSlot.class, list2));
