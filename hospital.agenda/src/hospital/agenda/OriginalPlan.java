		...
		if (localDoctorID != null) {
			for (int i = 0; i < localDoctorID.length; i++) {
				...
				if (localDoctorID[i] != null) {
					...
					elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDoctorID[i]));
				} else {
		...
		if (localRoomID != null) {
			for (int i = 0; i < localRoomID.length; i++) {
				...
				if (localRoomID[i] != null) {
					...
					elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRoomID[i]));
				} else {
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://hospital/agenda/", "DoctorID")
					...
					while (!loopDone2) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://hospital/agenda/", "DoctorID")
									.equals(reader.getName())) {
								list2.add(reader.getElementText());
					...
					object.setDoctorID((java.lang.String[]) list2.toArray(new java.lang.String[list2.size()]));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://hospital/agenda/", "RoomID")
					...
					while (!loopDone4) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://hospital/agenda/", "RoomID")
									.equals(reader.getName())) {
								list4.add(reader.getElementText());
					...
					object.setRoomID((java.lang.String[]) list4.toArray(new java.lang.String[list4.size()]));
