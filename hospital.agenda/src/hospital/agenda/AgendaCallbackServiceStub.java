...
public class AgendaCallbackServiceStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		__operation.setName(new javax.xml.namespace.QName("http://hospital/agenda/", "receiveCallback"));
...

	{
		...
		_operationClient.getOptions().setAction("http://hospital/agenda/receiveCallback");
		...
		env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), agendaCallback,
				optimizeContent(new javax.xml.namespace.QName("http://hospital/agenda/", "receiveCallback")),
				new javax.xml.namespace.QName("http://hospital/agenda/", "receiveCallback"));
	...
	// http://localhost:8080/ode/processes/AgendaCallbackService
