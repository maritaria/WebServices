...
public class GetBookPriceResponse implements org.apache.axis2.databinding.ADBBean {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"getBookPriceResponse".equals(type)) {
							...
							return (GetBookPriceResponse) com.example.www.bookquote.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
