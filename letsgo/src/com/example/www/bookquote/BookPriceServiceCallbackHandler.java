...
/**
 * BookPriceServiceCallbackHandler Callback class, Users can extend this class
...
public abstract class BookPriceServiceCallbackHandler {
	...
	/**
	 * auto generated Axis2 call back method for getBookPrice method override this
	 * method for handling normal response from getBookPrice operation
	 */
	public void receiveResultgetBookPrice(com.example.www.bookquote.BookPriceServiceStub.GetBookPriceResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling error
	 * response from getBookPrice operation
	 */
