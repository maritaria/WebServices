...
/**
 * Timestamp bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class Timestamp implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":timestamp", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "timestamp", xmlWriter);
			}
		}
	...
	public static class Factory {
		...
		public static Timestamp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			Timestamp object = new Timestamp();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://medicare.com/Types", "timestamp")
