...
/**
 * TreatmentE bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class TreatmentE implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		localTreatment.serialize(MY_QNAME, xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		// We can safely assume an element has only one type associated with it
		return localTreatment.getPullParser(MY_QNAME);
	...
	public static class Factory {
		 ...
		 */
		public static TreatmentE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TreatmentE object = new TreatmentE();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://medicare.com/Types", "treatment")
