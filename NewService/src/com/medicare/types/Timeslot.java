...
public class Timeslot implements org.apache.axis2.databinding.ADBBean {
	/*
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("http://medicare.com/Types", "timestamp"));
	...
	public static class Factory {
		...
		public static Timeslot parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Timeslot".equals(type)) {
							...
							return (Timeslot) com.medicare.services.room.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "timestamp")
