...
public class Treatment implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		localRequirements.serialize(new javax.xml.namespace.QName("", "requirements"), xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("http://medicare.com/Types", "duration"));
		...
		elementList.add(new javax.xml.namespace.QName("", "requirements"));
	...
	public static class Factory {
		...
		public static Treatment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Treatment".equals(type)) {
							...
							return (Treatment) com.medicare.services.room.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "duration")
						.equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "requirements").equals(reader.getName())) {
