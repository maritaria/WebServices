...
public class PatientE implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		localPatient.serialize(MY_QNAME, xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		// We can safely assume an element has only one type associated with it
		return localPatient.getPullParser(MY_QNAME);
	...
	public static class Factory {
		 ...
		 */
		public static PatientE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			PatientE object = new PatientE();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://medicare.com/Types", "patient")
