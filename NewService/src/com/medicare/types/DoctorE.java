...
public class DoctorE implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		localDoctor.serialize(MY_QNAME, xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		// We can safely assume an element has only one type associated with it
		return localDoctor.getPullParser(MY_QNAME);
	...
	public static class Factory {
		 ...
		 */
		public static DoctorE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			DoctorE object = new DoctorE();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://medicare.com/Types", "doctor")
										.equals(reader.getName())) {

							object.setDoctor(com.medicare.types.Doctor.Factory.parse(reader));
