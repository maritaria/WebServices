...
/**
 * TimeslotE bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class TimeslotE implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		localTimeslot.serialize(MY_QNAME, xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		// We can safely assume an element has only one type associated with it
		return localTimeslot.getPullParser(MY_QNAME);
	...
	public static class Factory {
		 ...
		 */
		public static TimeslotE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			TimeslotE object = new TimeslotE();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://medicare.com/Types", "timeslot")
