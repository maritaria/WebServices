...
public class ScheduledTreatment implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * ScheduledTreatment Namespace URI = http://medicare.com/Types Namespace Prefix
	 * = ns1
	 */
	...
	/**
	 * field for Doctor This was an Array!
	 */
	...
	public void addDoctor(com.medicare.types.Doctor param) {
		...
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDoctor);
		list.add(param);
		this.localDoctor = (com.medicare.types.Doctor[]) list.toArray(new com.medicare.types.Doctor[list.size()]);

	}

	/**
	 * field for Patient This was an Array!
	 */
	...
	public void addPatient(com.medicare.types.Patient param) {
		...
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localPatient);
		list.add(param);
		this.localPatient = (com.medicare.types.Patient[]) list.toArray(new com.medicare.types.Patient[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		localTreatment.serialize(new javax.xml.namespace.QName("http://medicare.com/Types", "treatment"), xmlWriter);
		...
		localRoom.serialize(new javax.xml.namespace.QName("http://medicare.com/Types", "room"), xmlWriter);

		if (localTimeslot == null) {
			throw new org.apache.axis2.databinding.ADBException("timeslot cannot be null!!");
		}
		localTimeslot.serialize(new javax.xml.namespace.QName("http://medicare.com/Types", "timeslot"), xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("http://medicare.com/Types", "treatment"));
		...
		if (localDoctor != null) {
			for (int i = 0; i < localDoctor.length; i++) {
				...
				if (localDoctor[i] != null) {
					elementList.add(new javax.xml.namespace.QName("http://medicare.com/Types", "doctor"));
		...
		if (localPatient != null) {
			for (int i = 0; i < localPatient.length; i++) {
				...
				if (localPatient[i] != null) {
					elementList.add(new javax.xml.namespace.QName("http://medicare.com/Types", "patient"));
		...
		elementList.add(new javax.xml.namespace.QName("http://medicare.com/Types", "room"));
		...
		elementList.add(new javax.xml.namespace.QName("http://medicare.com/Types", "timeslot"));
		...
		public static ScheduledTreatment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ScheduledTreatment".equals(type)) {
							...
							return (ScheduledTreatment) com.medicare.services.room.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
				...
				if (tempAttribId != null) {
					...
					object.setId(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(tempAttribId));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "treatment")
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "doctor")
						.equals(reader.getName())) {
					...
					while (!loopDone2) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://medicare.com/Types", "doctor")
									.equals(reader.getName())) {
								list2.add(com.medicare.types.Doctor.Factory.parse(reader));
					...
					object.setDoctor((com.medicare.types.Doctor[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(com.medicare.types.Doctor.class, list2));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "patient")
						.equals(reader.getName())) {
					...
					while (!loopDone3) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://medicare.com/Types", "patient")
									.equals(reader.getName())) {
								list3.add(com.medicare.types.Patient.Factory.parse(reader));
					...
					object.setPatient((com.medicare.types.Patient[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(com.medicare.types.Patient.class, list3));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "room")
						.equals(reader.getName())) {
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "timeslot")
						.equals(reader.getName())) {
