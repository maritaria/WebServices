...
public class RoomE implements org.apache.axis2.databinding.ADBBean {
	...
	public static class Factory {
		 ...
		 */
		public static RoomE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			RoomE object = new RoomE();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://medicare.com/Types", "room")
