...
public class Patients implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://medicare.com/Types",
			"patients", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":patients", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "patients", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 */
		public static Patients parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			Patients object = new Patients();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"patients".equals(type)) {
							...
							return (Patients) com.medicare.services.room.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "patient")
					...
					list1.add(com.medicare.types.Patient.Factory.parse(reader));
					...
					object.setPatient((com.medicare.types.Patient[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(com.medicare.types.Patient.class, list1));
