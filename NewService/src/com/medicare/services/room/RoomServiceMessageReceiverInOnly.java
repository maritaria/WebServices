...
/**
 * RoomServiceMessageReceiverInOnly.java
 *
...
/**
 * RoomServiceMessageReceiverInOnly message receiver
 */

public class RoomServiceMessageReceiverInOnly extends org.apache.axis2.receivers.AbstractInMessageReceiver {
			...
			if ((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils
				...
				if ("reservate".equals(methodName)) {
					...
					com.medicare.services.room.Reservate wrappedParam = (com.medicare.services.room.Reservate) fromOM(
							...
							com.medicare.services.room.Reservate.class, getEnvelopeNamespaces(inMessage.getEnvelope()));
