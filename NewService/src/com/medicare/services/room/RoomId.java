...
public class RoomId implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://medicare.com/Services/Room", "RoomId", "ns3");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		java.lang.String namespace = "http://medicare.com/Services/Room";
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://medicare.com/Services/Room", "RoomId")
