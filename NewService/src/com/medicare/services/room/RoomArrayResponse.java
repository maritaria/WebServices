...
/**
 * RoomArrayResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class RoomArrayResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://medicare.com/Services/Room", "RoomArrayResponse", "ns2");
	 ...
	 */
	protected void validateRoom(com.medicare.types.Room[] param) {
	 ...
	 * 
	 * @param param
	 *            com.medicare.types.Room
	 */
	public void addRoom(com.medicare.types.Room param) {
		if (localRoom == null) {
			localRoom = new com.medicare.types.Room[] {};
		}
		...
		list.add(param);
		this.localRoom = (com.medicare.types.Room[]) list.toArray(new com.medicare.types.Room[list.size()]);
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":RoomArrayResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RoomArrayResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 */
		public static RoomArrayResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			RoomArrayResponse object = new RoomArrayResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"RoomArrayResponse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (RoomArrayResponse) com.medicare.services.room.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "room").equals(reader.getName())) {
					...
					list1.add(com.medicare.types.Room.Factory.parse(reader));
					...
					object.setRoom((com.medicare.types.Room[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(com.medicare.types.Room.class, list1));
