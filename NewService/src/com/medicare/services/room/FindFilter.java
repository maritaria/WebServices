...
public class FindFilter implements org.apache.axis2.databinding.ADBBean {
	...
	protected org.apache.axis2.databinding.types.Duration localAvailableTime;
	 ...
	 */
	public org.apache.axis2.databinding.types.Duration getAvailableTime() {
	 ...
	 *            AvailableTime
	 */
	public void setAvailableTime(org.apache.axis2.databinding.types.Duration param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":FindFilter", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FindFilter", xmlWriter);
			}
		...
		if (localAvailableTime == null) {
			...
			throw new org.apache.axis2.databinding.ADBException("availableTime cannot be null!!");

		} else {

			xmlWriter.writeCharacters(
					org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAvailableTime));
		...
		if (localEquipment == null) {
			...
			xmlWriter.writeCharacters(localEquipment);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("", "availableTime"));

		if (localAvailableTime != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAvailableTime));
		} else {
			throw new org.apache.axis2.databinding.ADBException("availableTime cannot be null!!");
		}
		...
		if (localEquipment != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localEquipment));
		} else {
			throw new org.apache.axis2.databinding.ADBException("equipment cannot be null!!");
		}
	...
	public static class Factory {
		 ...
		 */
		public static FindFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			FindFilter object = new FindFilter();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FindFilter".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (FindFilter) com.medicare.services.room.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "availableTime").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "availableTime" + "  cannot be null");
					}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://medicare.com/Types", "equipment")
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "equipment" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setEquipment(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
