...
public abstract class DoctorServiceCallbackHandler {
	 ...
	 */
	public void receiveResultfind(com.medicare.services.doctor.DoctorArrayResponse result) {
	}
	 ...
	 */
	public void receiveResultgetAll(com.medicare.services.doctor.DoctorArrayResponse result) {
	}
	 ...
	 */
	public void receiveResultget(com.medicare.types.DoctorE result) {
	}
	 ...
	 */
	public void receiveResultregister(com.medicare.types.DoctorE result) {
	}
