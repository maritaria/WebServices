        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("register".equals(methodName)){
                ...
                com.medicare.types.PatientE patient21 = null;
	                        com.medicare.types.PersonE wrappedParam =
                                                             (com.medicare.types.PersonE)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    com.medicare.types.PersonE.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), patient21, false, new javax.xml.namespace.QName("http://medicare.com/Services/Patient",
                                                    "register"));
                                    } else 

            if("notify".equals(methodName)){
                
                com.medicare.services.patient.Notify wrappedParam =
                                                             (com.medicare.services.patient.Notify)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
            ...
            if("getAll".equals(methodName)){
                ...
                com.medicare.types.Patients patients25 = null;
	                        patients25 =
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), patients25, false, new javax.xml.namespace.QName("http://medicare.com/Services/Patient",
                                                    "getAll"));
        ...
        //
            ...
            throws org.apache.axis2.AxisFault {
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.medicare.types.PatientE param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.medicare.types.Patients param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
