...
public class PatientServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
	...
	public void invokeBusinessLogic(org.apache.axis2.context.MessageContext msgContext,
		...
		try {
			...
			if ((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils
				...
				if ("registerPatient".equals(methodName)) {

					com.medicare.types.PatientE patient14 = null;
					...
					patient14 =
							...
							skel.registerPatient(wrappedParam);

					envelope = toEnvelope(getSOAPFactory(msgContext), patient14, false,
							new javax.xml.namespace.QName("http://medicare.com/Services/Patient", "registerPatient"));
				} else

				if ("getAll".equals(methodName)) {

					com.medicare.types.Patients patients16 = null;
					patients16 =

							skel.getAll();

					envelope = toEnvelope(getSOAPFactory(msgContext), patients16, false,
	...
	private com.medicare.types.PatientE wrapRegisterPatient() {
