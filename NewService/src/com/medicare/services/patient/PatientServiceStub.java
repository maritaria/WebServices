...
public class PatientServiceStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		__operation.setName(new javax.xml.namespace.QName("http://medicare.com/Services/Patient", "registerPatient"));
	...
	private void populateFaults() {
		...
		faultExceptionNameMap.put(
				new org.apache.axis2.client.FaultMapKey(
						new javax.xml.namespace.QName("http://medicare.com/Types", "error"), "RegisterPatient"),
				"com.medicare.services.patient.RegisterPatientFault");
	 ...
	 * 
	 * @see com.medicare.services.patient.PatientService#registerPatient
	 * @param person29
	 * 
	 * @throws com.medicare.services.patient.RegisterPatientFault
	 *             :
	 */

	public com.medicare.types.PatientE registerPatient(

			com.medicare.types.PersonE person29)
		...
		try {
			...
			_operationClient.getOptions().setAction("http://medicare.com/Services/Patient/RegisterPatient");
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), person29,
					optimizeContent(
							new javax.xml.namespace.QName("http://medicare.com/Services/Patient", "registerPatient")),
					new javax.xml.namespace.QName("http://medicare.com/Services/Patient", "registerPatient"));
			...
			if (faultElt != null) {
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "RegisterPatient"))) {
					// make the fault by reflection
					try {
						java.lang.String exceptionClassName = (java.lang.String) faultExceptionClassNameMap
								.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "RegisterPatient"));
						...
						if (ex instanceof com.medicare.services.patient.RegisterPatientFault) {
							throw (com.medicare.services.patient.RegisterPatientFault) ex;
						}
	 ...
	 * 
	 * @see com.medicare.services.patient.PatientService#startregisterPatient
	 * @param person29
	 * 
	 */
	public void startregisterPatient(
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					callback.receiveResultregisterPatient((com.medicare.types.PatientE) object);

				} catch (org.apache.axis2.AxisFault e) {
					callback.receiveErrorregisterPatient(e);
				}
			}
				...
				if (error instanceof org.apache.axis2.AxisFault) {
					...
					if (faultElt != null) {
						if (faultExceptionNameMap.containsKey(
								new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "RegisterPatient"))) {
							// make the fault by reflection
							try {
								java.lang.String exceptionClassName = (java.lang.String) faultExceptionClassNameMap
								...
								if (ex instanceof com.medicare.services.patient.RegisterPatientFault) {
									callback.receiveErrorregisterPatient(
											(com.medicare.services.patient.RegisterPatientFault) ex);
									return;
								}

								callback.receiveErrorregisterPatient(new java.rmi.RemoteException(ex.getMessage(), ex));
							} catch (java.lang.ClassCastException e) {
								// we cannot intantiate the class - throw the original Axis fault
								callback.receiveErrorregisterPatient(f);
							} catch (java.lang.ClassNotFoundException e) {
								// we cannot intantiate the class - throw the original Axis fault
								callback.receiveErrorregisterPatient(f);
							} catch (java.lang.NoSuchMethodException e) {
					...
					callback.receiveErrorregisterPatient(error);
				}
			}
			...
			public void onComplete() {
				try {
					...
					callback.receiveErrorregisterPatient(axisFault);
				}
			}
		});
