...
public class RoomServiceStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		__operation.setName(new javax.xml.namespace.QName("http://hospital/room/", "findRoom"));
	...
	public RoomServiceStub(org.apache.axis2.context.ConfigurationContext configurationContext)
		...
		this(configurationContext, "http://localhost:9080/hospital.room/services/RoomService");
	...
	public RoomServiceStub() throws org.apache.axis2.AxisFault {
		...
		this("http://localhost:9080/hospital.room/services/RoomService");
	 ...
	 * 
	 * @see hospital.room.RoomService#findRoom
	 * @param items
	 * 
	 */

	public hospital.room.RoomServiceStub.RoomIDs findRoom(

			hospital.room.RoomServiceStub.Items items)
...

	{
		...
		try {
			...
			_operationClient.getOptions().setAction("http://hospital/room/findRoom");
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), items,
					optimizeContent(new javax.xml.namespace.QName("http://hospital/room/", "findRoom")),
					new javax.xml.namespace.QName("http://hospital/room/", "findRoom"));
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(),
					hospital.room.RoomServiceStub.RoomIDs.class, getEnvelopeNamespaces(_returnEnv));

			return (hospital.room.RoomServiceStub.RoomIDs) object;
			...
			if (faultElt != null) {
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "findRoom"))) {
					// make the fault by reflection
					try {
						java.lang.String exceptionClassName = (java.lang.String) faultExceptionClassNameMap
								.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "findRoom"));
	...
	// http://localhost:9080/hospital.room/services/RoomService
	...
	private org.apache.axiom.om.OMElement toOM(hospital.room.RoomServiceStub.Items param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(hospital.room.RoomServiceStub.Items.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(hospital.room.RoomServiceStub.RoomIDs param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(hospital.room.RoomServiceStub.RoomIDs.MY_QNAME,
					org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			hospital.room.RoomServiceStub.Items param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
			throws org.apache.axis2.AxisFault {

		try {

			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
			emptyEnvelope.getBody().addChild(param.getOMElement(hospital.room.RoomServiceStub.Items.MY_QNAME, factory));
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param, java.lang.Class type,
		...
		try {
			...
			if (hospital.room.RoomServiceStub.Items.class.equals(type)) {

				return hospital.room.RoomServiceStub.Items.Factory.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (hospital.room.RoomServiceStub.RoomIDs.class.equals(type)) {

				return hospital.room.RoomServiceStub.RoomIDs.Factory.parse(param.getXMLStreamReaderWithoutCaching());
