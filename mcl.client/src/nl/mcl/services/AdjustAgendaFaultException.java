...
public class AdjustAgendaFaultException extends java.lang.Exception {
	...
	private static final long serialVersionUID = 1520587987563L;

	private nl.mcl.services.AgendaServiceStub.AdjustAgendaFault faultMessage;
	...
	public void setFaultMessage(nl.mcl.services.AgendaServiceStub.AdjustAgendaFault msg) {
		faultMessage = msg;
	}

	public nl.mcl.services.AgendaServiceStub.AdjustAgendaFault getFaultMessage() {
		return faultMessage;
	}
}
