...
/**
 * Skills_type0 bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class Skills_type0 implements org.apache.axis2.databinding.ADBBean {
	/*
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Skills_type0", xmlWriter);
			}
		...
		public static Skills_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Skills_type0".equals(type)) {
							...
							return (Skills_type0) hospital.patient.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://hospital/schema/", "Skill").equals(reader.getName())) {
